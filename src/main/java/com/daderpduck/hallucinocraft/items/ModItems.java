...
public class ModItems {
    ...
    public static final RegistryObject<Item> COCAINE_DUST = register("cocaine_dust", () -> new SnortDrugItem(new DrugItem.Properties().addDrug(DrugRegistry.COCAINE, 100, 0.01F, 400).edible().tab(Hallucinocraft.TAB)));
