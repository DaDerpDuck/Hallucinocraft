...
public class ModItems {
    ...
    public static final RegistryObject<Item> COCAINE_POWDER = register("cocaine_powder", () -> new SnortDrugItem(new DrugItem.Properties().addDrug(DrugRegistry.COCAINE, 100, 0.6F, 3200).edible().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> COCA_LEAF = register("coca_leaf", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> COCA_MULCH = register("coca_mulch", () -> new Item(new Item.Properties().tab(ItemGroup.TAB_MATERIALS)));
    public static final RegistryObject<Item> COCAINE_DUST = register("cocaine_dust", () -> new SnortDrugItem(new DrugItem.Properties().addDrug(DrugRegistry.COCAINE, 100, 0.1F, 400).edible().tab(ItemGroup.TAB_MATERIALS)));
