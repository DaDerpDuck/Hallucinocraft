...
public class ModItems {
    public static final RegistryObject<Item> RED_SHROOMS = registerDrug("red_shrooms", new DrugChain().add(DrugRegistry.RED_SHROOMS, 400, 0.3F, 9600));
    ...
    public static RegistryObject<Item> registerDrug(String name, DrugChain drugChain, UseAction useAction, int stackSize) {
    ...
    public static RegistryObject<Item> registerSyringe(String name, DrugChain drugChain, int color) {
    ...
    private static class DrugChain {
