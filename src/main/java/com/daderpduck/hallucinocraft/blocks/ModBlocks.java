...
public class ModBlocks {
    ...
    public static final RegistryObject<TallCropsBlock> CANNABIS_BLOCK = register("cannabis", () -> new CannabisBlock(AbstractBlock.Properties.of(Material.PLANT).instabreak().noCollission().randomTicks().sound(SoundType.CROP)));
    ...
    public static void initRenderTypes() {
        ...
        RenderTypeLookup.setRenderLayer(CANNABIS_BLOCK.get(), RenderType.cutout());
