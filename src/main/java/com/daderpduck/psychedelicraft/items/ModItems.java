...
public class ModItems {
    ...
    public static final RegistryObject<Item> BROWN_SHROOMS = register("brown_shrooms", () -> new DrugItem(new DrugItem.Properties().addDrug(DrugRegistry.BROWN_SHROOMS, 200, 0.6F, 3200).edible().tab(ItemGroup.TAB_MATERIALS)));
